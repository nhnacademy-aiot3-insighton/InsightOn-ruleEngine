...
@EnableConfigurationProperties(GroupDeletionProperties.class)
public class GroupDeletionConfiguration {

    @Bean
    Declarables groupDeletionTopology(GroupDeletionProperties properties) {
    ...
    @Bean(name = "groupDeletionListenerContainerFactory")
    SimpleRabbitListenerContainerFactory groupDeletionListenerContainerFactory(
            SimpleRabbitListenerContainerFactoryConfigurer configurer,
            ConnectionFactory connectionFactory,
            RabbitTemplate rabbitTemplate,
            GroupDeletionProperties properties
    ) {
        properties.validateEnabledConfiguration();
